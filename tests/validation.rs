...
// ## External Select Validation
should_fail!(
    external_select_with_invalid_confirm:
    BlockElement::from(
        select::External::from_placeholder_and_action_id("", "")
                     .with_confirm(
                         compose::Confirm::from_parts(
                             common::string_of_len(101),
                             "".plaintext(),
...
should_fail!(
    external_select_with_long_placeholder:
    BlockElement::from(
        select::External::from_placeholder_and_action_id(
            common::string_of_len(151),
            ""
...
should_fail!(
    external_select_with_long_action_id:
    BlockElement::from(
        select::External::from_placeholder_and_action_id(
            "",
            common::string_of_len(256),
